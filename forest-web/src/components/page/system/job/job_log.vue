    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 调度日志</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
export default {
  ...
  methods: {
    ...
    rest() {
      this.filterTime='2020-07-07 00:00:00 - 2020-07-07 23:59:59',
      this.selectTime='2';
      this.jobGroup='0';
      this.jobId='0';
      this.logStatus='-1'
    ...
    async data(){
       const res = await this.$http.get(baseURL_.jobUrl + "/joblog/data");
    ...
    async getData() {
      const log = await this.$http.get(baseURL_.jobUrl + "/joblog/list", {
        params: {
          page: this.page,
